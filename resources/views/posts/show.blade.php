        ...
        <div class="blog-title-area">
            <ol class="breadcrumb hidden-xs-down">
                ...
                <li class="breadcrumb-item">
                        <a
                        href={{ $post->category ?  route('category.show',['slug'=>$post->category->slug]) : '#None'}}>{{$post->category->name ?? 'None'}}</a>
                </li>
                <li class="breadcrumb-item active">{{$post->title}}</li>
            </ol>

            <span class="color-yellow">
                <a href="{{ $post->category ?  route('category.show',['slug'=>$post->category->slug]) : '#None'}}"
                                          title="">{{$post->category->name?? 'None'}}</a></span>
            ...
            @if($post->tags->count())
                <div class="tag-cloud-single">
                    ...
                    @foreach($post->tags as $tag)
                        <small><a href="{{route('tag.show',['slug'=>$tag->slug])}}" title="">{{$tag->name}}</a></small>
                    @endforeach
                </div><!-- end meta -->
            @endif
