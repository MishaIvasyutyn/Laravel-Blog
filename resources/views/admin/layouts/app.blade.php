<!DOCTYPE html>
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en" style="font-size: 1.1em
">
<head>
    <meta charset="UTF-8"/>
...
{{--                @endif--}}
                @if(session()->has('success'))
                    <div
                        class="p-3  mt-4 mb-4 font-semibold leading-tight text-green-700 bg-green-100 rounded-lg dark:text-green-100 dark:bg-green-500">
