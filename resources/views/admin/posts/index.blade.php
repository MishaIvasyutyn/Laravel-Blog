            ...
            <div class="container grid px-6 mx-auto">
                ...
                <div class="w-full overflow-hidden rounded-lg shadow-xs">
                    <div class="w-full overflow-x-auto">
                        ...
                        <span
                            class="px-2 py-1 font-semibold leading-tight text-gray-500 bg-orange-100 rounded-full dark:bg-orange-600 dark:text-green-100"
                        >
                         {{ $post->category->name ?? 'None' }}
                                        ...
                                        <td class="px-4 py-3 text-xs">
                        <span
                            class="px-2 py-1 font-semibold leading-tight text-green-700 bg-blue-100 rounded-full dark:bg-blue-500 dark:text-green-100"
                        >
                       @if(count($post->tags))
