            ...
            <form action="{{route('admin.posts.store')}}" method="post" enctype="multipart/form-data">
                ...
                <label class="block mt-4 text-sm">
                    ...
                    <textarea id="content"
                        ...
                        rows="6" placeholder="Content..." name="content">{{old('content')}}</textarea>
                    @error('content')
                    <span class="mt-8 text-xs text-red-600 dark:text-red-400">
                        {{$message}}
                     </span>
                ...
                <label class="block mt-4 text-sm">
                    ...
                    <textarea
                        ...
                        rows="4" placeholder="Description..." name="description">{{old('description')}}</textarea>
                    @error('description')
                    <span class="mt-8 text-xs text-red-600 dark:text-red-400">
                        {{$message}}
                     </span>
